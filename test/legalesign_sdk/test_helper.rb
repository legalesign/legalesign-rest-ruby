...
class LegalesignSDK::Test::SingletonClient < LegalesignSDK::Client
  include Singleton

  TEST_API_BASE_URL = ENV.fetch("TEST_API_BASE_URL", "http://localhost:4010")

  def initialize
    super(base_url: LegalesignSDK::Test::SingletonClient::TEST_API_BASE_URL, api_key: "My API Key")
  end
end
...
class LegalesignSDK::Test::ResourceTest < Minitest::Test
  def async?
  ...
  def before_all
    super
    @legalesign_sdk = LegalesignSDK::Test::SingletonClient.instance
  end
