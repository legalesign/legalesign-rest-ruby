...
class LegalesignSDK::Test::PrimitiveModelTest < Minitest::Test
  A = LegalesignSDK::Internal::Type::ArrayOf[-> { Integer }]
  H = LegalesignSDK::Internal::Type::HashOf[-> { Integer }, nil?: true]
  ...
  class B < LegalesignSDK::Internal::Type::BaseModel
    optional :a, Integer
    optional :b, B
  end
  ...
  def test_typing
    converters = [
      LegalesignSDK::Internal::Type::Unknown,
      LegalesignSDK::Internal::Type::Boolean,
      A,
      H,
      E,
      U,
    ...
    converters.each do |conv|
      assert_pattern do
        conv => LegalesignSDK::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    cases = {
      [LegalesignSDK::Internal::Type::Unknown, :a] => [{yes: 1}, :a],
      [NilClass, :a] => [{maybe: 1}, nil],
      [NilClass, nil] => [{yes: 1}, nil],
      [LegalesignSDK::Internal::Type::Boolean, true] => [{yes: 1}, true],
      [LegalesignSDK::Internal::Type::Boolean, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
    ...
    cases.each do |lhs, rhs|
      ...
      state = LegalesignSDK::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        LegalesignSDK::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      [LegalesignSDK::Internal::Type::Unknown, B.new(a: "one", b: B.new(a: 1.0))] => {a: "one", b: {a: 1}},
      ...
      [LegalesignSDK::Internal::Type::Boolean, true] => true,
      [LegalesignSDK::Internal::Type::Boolean, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
      ...
      [String, Pathname(__FILE__)] => LegalesignSDK::FilePart
    }
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        LegalesignSDK::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do |testcase, expect|
      ...
      state = LegalesignSDK::Internal::Type::Converter.new_coerce_state
      LegalesignSDK::Internal::Type::Converter.coerce(target, input, state: state)
      assert_pattern do
        state => {error: ^expect}
      end
    end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        LegalesignSDK::Internal::Type::Converter.dump(target, input, state: state)
...
class LegalesignSDK::Test::EnumModelTest < Minitest::Test
  class E0
    include LegalesignSDK::Internal::Type::Enum
...
class LegalesignSDK::Test::CollectionModelTest < Minitest::Test
  A1 = LegalesignSDK::Internal::Type::ArrayOf[-> { Integer }]
  H1 = LegalesignSDK::Internal::Type::HashOf[Integer]

  A2 = LegalesignSDK::Internal::Type::ArrayOf[H1]
  H2 = LegalesignSDK::Internal::Type::HashOf[-> { A1 }]

  A3 = LegalesignSDK::Internal::Type::ArrayOf[Integer, nil?: true]
  H3 = LegalesignSDK::Internal::Type::HashOf[Integer, nil?: true]
...
class LegalesignSDK::Test::BaseModelTest < Minitest::Test
  class M1 < LegalesignSDK::Internal::Type::BaseModel
    required :a, Integer
  end
  ...
  class M3 < LegalesignSDK::Internal::Type::BaseModel
    optional :c, const: :c
    required :d, const: :d
  end
  ...
  class M5 < LegalesignSDK::Internal::Type::BaseModel
    request_only do
      required :c, const: :c
    end
  ...
  class M6 < M1
    required :a, LegalesignSDK::Internal::Type::ArrayOf[M6]
    optional :b, M6
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      state = LegalesignSDK::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        coerced = LegalesignSDK::Internal::Type::Converter.coerce(target, input, state: state)
        assert_equal(coerced, coerced)
        if coerced.is_a?(LegalesignSDK::Internal::Type::BaseModel)
          coerced.to_h => ^expect
        else
          coerced => ^expect
        end
      ...
      attributes.each do |accessor, expect|
        ...
        in Class if expect <= StandardError
          tap do
            ...
            flunk
          rescue LegalesignSDK::Errors::ConversionError => e
...
class LegalesignSDK::Test::UnionTest < Minitest::Test
  class U0
    include LegalesignSDK::Internal::Type::Union
  ...
  class M2 < LegalesignSDK::Internal::Type::BaseModel
  ...
  class M4 < LegalesignSDK::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :a, LegalesignSDK::Internal::Type::ArrayOf[-> { U5 }]
  end

  class M5 < LegalesignSDK::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :b, LegalesignSDK::Internal::Type::ArrayOf[-> { U5 }]
  end
...
class LegalesignSDK::Test::BaseModelQoLTest < Minitest::Test
  class E0
    include LegalesignSDK::Internal::Type::Enum
  ...
  def test_equality
    cases = {
      [LegalesignSDK::Internal::Type::Unknown, LegalesignSDK::Internal::Type::Unknown] => true,
      [LegalesignSDK::Internal::Type::Boolean, LegalesignSDK::Internal::Type::Boolean] => true,
      [LegalesignSDK::Internal::Type::Unknown, LegalesignSDK::Internal::Type::Boolean] => false,
...
class LegalesignSDK::Test::MetaInfoTest < Minitest::Test
  A1 = LegalesignSDK::Internal::Type::ArrayOf[Integer, nil?: true, doc: "dog"]
  H1 = LegalesignSDK::Internal::Type::HashOf[-> { String }, nil?: true, doc: "dawg"]
