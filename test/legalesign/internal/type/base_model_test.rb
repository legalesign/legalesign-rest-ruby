...
class Legalesign::Test::PrimitiveModelTest < Minitest::Test
  A = Legalesign::Internal::Type::ArrayOf[-> { Integer }]
  H = Legalesign::Internal::Type::HashOf[-> { Integer }, nil?: true]
  ...
  module U
    extend Legalesign::Internal::Type::Union
  end

  class B < Legalesign::Internal::Type::BaseModel
    optional :a, Integer
    optional :b, B
  end
  ...
  def test_typing
    converters = [
      Legalesign::Internal::Type::Unknown,
      Legalesign::Internal::Type::Boolean,
      A,
      H,
      E,
      U,
    ...
    converters.each do |conv|
      assert_pattern do
        conv => Legalesign::Internal::Type::Converter
      end
    end
  end
  ...
  def test_coerce
    cases = {
      [Legalesign::Internal::Type::Unknown, :a] => [{yes: 1}, :a],
      [NilClass, :a] => [{maybe: 1}, nil],
      [NilClass, nil] => [{yes: 1}, nil],
      [Legalesign::Internal::Type::Boolean, true] => [{yes: 1}, true],
      [Legalesign::Internal::Type::Boolean, "true"] => [{no: 1}, "true"],
      [Integer, 1] => [{yes: 1}, 1],
    ...
    cases.each do |lhs, rhs|
      ...
      state = Legalesign::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        Legalesign::Internal::Type::Converter.coerce(target, input, state: state) => ^expect
  ...
  def test_dump
    cases = {
      [Legalesign::Internal::Type::Unknown, B.new(a: "one", b: B.new(a: 1.0))] => {a: "one", b: {a: 1}},
      ...
      [Legalesign::Internal::Type::Boolean, true] => true,
      [Legalesign::Internal::Type::Boolean, "true"] => "true",
      [Integer, "1"] => "1",
      [Float, 1] => 1,
      [String, "one"] => "one",
      ...
      [String, Pathname(__FILE__)] => Legalesign::FilePart
    }
    ...
    cases.each do
      ...
      expect = _2
      assert_pattern do
        Legalesign::Internal::Type::Converter.dump(target, input) => ^expect
      end
    end
  end
  ...
  def test_coerce_errors
    ...
    cases.each do |testcase, expect|
      ...
      state = Legalesign::Internal::Type::Converter.new_coerce_state
      Legalesign::Internal::Type::Converter.coerce(target, input, state: state)
      assert_pattern do
        state => {error: ^expect}
      end
    end
  ...
  def test_dump_retry
    ...
    Pathname(__FILE__).open do |fd|
      ...
      types.product(cases).each do |target, input|
        ...
        Legalesign::Internal::Type::Converter.dump(target, input, state: state)
...
class Legalesign::Test::EnumModelTest < Minitest::Test
  class E0
    include Legalesign::Internal::Type::Enum
...
class Legalesign::Test::CollectionModelTest < Minitest::Test
  A1 = Legalesign::Internal::Type::ArrayOf[-> { Integer }]
  H1 = Legalesign::Internal::Type::HashOf[Integer]

  A2 = Legalesign::Internal::Type::ArrayOf[H1]
  H2 = Legalesign::Internal::Type::HashOf[-> { A1 }]

  A3 = Legalesign::Internal::Type::ArrayOf[Integer, nil?: true]
  H3 = Legalesign::Internal::Type::HashOf[Integer, nil?: true]
...
class Legalesign::Test::BaseModelTest < Minitest::Test
  class M1 < Legalesign::Internal::Type::BaseModel
    required :a, Integer
  end
  ...
  class M3 < Legalesign::Internal::Type::BaseModel
    optional :c, const: :c
    required :d, const: :d
  end
  ...
  class M5 < Legalesign::Internal::Type::BaseModel
    request_only do
      required :c, const: :c
    end
  ...
  class M6 < M1
    required :a, Legalesign::Internal::Type::ArrayOf[M6]
    optional :b, M6
  end
  ...
  def test_coerce
    ...
    cases.each do |lhs, rhs|
      ...
      state = Legalesign::Internal::Type::Converter.new_coerce_state
      assert_pattern do
        coerced = Legalesign::Internal::Type::Converter.coerce(target, input, state: state)
        assert_equal(coerced, coerced)
        if coerced.is_a?(Legalesign::Internal::Type::BaseModel)
          coerced.to_h => ^expect
        else
          coerced => ^expect
        end
      ...
      attributes.each do |accessor, expect|
        ...
        in Class if expect <= StandardError
          tap do
            ...
            flunk
          rescue Legalesign::Errors::ConversionError => e
...
class Legalesign::Test::UnionTest < Minitest::Test
  class U0
    include Legalesign::Internal::Type::Union
  ...
  class M2 < Legalesign::Internal::Type::BaseModel
  ...
  class M4 < Legalesign::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :a, Legalesign::Internal::Type::ArrayOf[-> { U5 }]
  end

  class M5 < Legalesign::Internal::Type::BaseModel
    optional :recur, -> { U5 }
    required :b, Legalesign::Internal::Type::ArrayOf[-> { U5 }]
  end
...
class Legalesign::Test::BaseModelQoLTest < Minitest::Test
  class E0
    include Legalesign::Internal::Type::Enum
  ...
  def test_equality
    cases = {
      [Legalesign::Internal::Type::Unknown, Legalesign::Internal::Type::Unknown] => true,
      [Legalesign::Internal::Type::Boolean, Legalesign::Internal::Type::Boolean] => true,
      [Legalesign::Internal::Type::Unknown, Legalesign::Internal::Type::Boolean] => false,
...
class Legalesign::Test::MetaInfoTest < Minitest::Test
  A1 = Legalesign::Internal::Type::ArrayOf[Integer, nil?: true, doc: "dog"]
  H1 = Legalesign::Internal::Type::HashOf[-> { String }, nil?: true, doc: "dawg"]
