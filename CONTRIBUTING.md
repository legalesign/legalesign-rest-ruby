...
```ruby
gem "legalesign-sdk", git: "https://www.github.com/legalesign/legalesign-rest-ruby"
```

Alternatively, reference local copy of the repo:

```bash
$ git clone -- 'https://www.github.com/legalesign/legalesign-rest-ruby' '<path-to-repo>'
```
