...
module LegalesignSDK
  module Models
    class DocumentGetFieldsResponseItem < LegalesignSDK::Internal::Type::BaseModel
      # @!attribute element_type
      #
      #   @return [Symbol, LegalesignSDK::Models::DocumentGetFieldsResponseItem::ElementType, nil]
      optional :element_type, enum: -> { LegalesignSDK::Models::DocumentGetFieldsResponseItem::ElementType }
      ...
      #   {LegalesignSDK::Models::DocumentGetFieldsResponseItem} for more details.
      #
      #   @param element_type [Symbol, LegalesignSDK::Models::DocumentGetFieldsResponseItem::ElementType]
      #
      ...
      # @see LegalesignSDK::Models::DocumentGetFieldsResponseItem#element_type
      module ElementType
    ...
    DocumentGetFieldsResponse =
      LegalesignSDK::Internal::Type::ArrayOf[-> { LegalesignSDK::Models::DocumentGetFieldsResponseItem }]
  end
end
