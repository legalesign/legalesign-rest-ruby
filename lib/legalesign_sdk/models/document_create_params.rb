...
module LegalesignSDK
  module Models
    ...
    class DocumentCreateParams < LegalesignSDK::Internal::Type::BaseModel
      ...
      # @!attribute signers
      #
      #   @return [Array<LegalesignSDK::Models::DocumentCreateParams::Signer>]
      required :signers,
               -> { LegalesignSDK::Internal::Type::ArrayOf[LegalesignSDK::DocumentCreateParams::Signer] }
      ...
      #
      #   @return [Boolean, nil]
      optional :append_pdf, LegalesignSDK::Internal::Type::Boolean
      ...
      #
      #   @return [Boolean, nil]
      optional :convert_sender_to_signer, LegalesignSDK::Internal::Type::Boolean
      ...
      #
      #   @return [Integer, LegalesignSDK::Models::DocumentCreateParams::PdfPasswordType, nil]
      optional :pdf_password_type, enum: -> { LegalesignSDK::DocumentCreateParams::PdfPasswordType }
      ...
      optional :pdftext, LegalesignSDK::Internal::Type::HashOf[String]
      ...
      #
      #   @return [Boolean, nil]
      optional :signers_in_order, LegalesignSDK::Internal::Type::Boolean
      ...
      #
      #   @return [Hash{Symbol=>String}, nil]
      optional :signertext, LegalesignSDK::Internal::Type::HashOf[String]

      # @!attribute strict_fields
      #   pdftext fails silently for invalid field value, set to true to return an error
      #
      #   @return [Boolean, nil]
      optional :strict_fields, LegalesignSDK::Internal::Type::Boolean
      ...
      #   {LegalesignSDK::Models::DocumentCreateParams} for more details.
      #
      #   @param group [String]
      #
      #   @param name [String]
      #
      #   @param signers [Array<LegalesignSDK::Models::DocumentCreateParams::Signer>]
      #
      ...
      #
      #   @param pdf_password_type [Integer, LegalesignSDK::Models::DocumentCreateParams::PdfPasswordType] 1 to store password, 2 for to delete from our records upon final signing.
      #
      ...
      class Signer < LegalesignSDK::Internal::Type::BaseModel
        # @!attribute email
        #
        #   @return [String]
        ...
        optional :attachments, LegalesignSDK::Internal::Type::ArrayOf[String]
        ...
        #
        #   @return [Boolean, nil]
        optional :decide_later, LegalesignSDK::Internal::Type::Boolean
        ...
        # @!attribute reviewers
        #
        #   @return [Array<LegalesignSDK::Models::DocumentCreateParams::Signer::Reviewer>, nil]
        optional :reviewers,
                 -> { LegalesignSDK::Internal::Type::ArrayOf[LegalesignSDK::DocumentCreateParams::Signer::Reviewer] }
        ...
        #   \"decide_later\").
        #
        #   @return [Symbol, LegalesignSDK::Models::DocumentCreateParams::Signer::Role, nil]
        optional :role, enum: -> { LegalesignSDK::DocumentCreateParams::Signer::Role }
        ...
        #   Some parameter documentations has been truncated, see
        #   {LegalesignSDK::Models::DocumentCreateParams::Signer} for more details.
        #
        #   @param email [String]
        #
        ...
        #
        #   @param reviewers [Array<LegalesignSDK::Models::DocumentCreateParams::Signer::Reviewer>]
        #
        #   @param role [Symbol, LegalesignSDK::Models::DocumentCreateParams::Signer::Role] If this person is a witness use \"witness\". Required where a witness is defined
        #
        ...
        class Reviewer < LegalesignSDK::Internal::Type::BaseModel
          # @!attribute email
          #
          #   @return [String]
          required :email, String
          ...
          #
          #   @return [Boolean, nil]
          optional :include_link, LegalesignSDK::Internal::Type::Boolean
        ...
        # \"decide_later\").
        #
        # @see LegalesignSDK::Models::DocumentCreateParams::Signer#role
        module Role
