...
module LegalesignSDK
  module Models
    module Templatepdf
      # @see LegalesignSDK::Resources::Templatepdf::Fields#create
      class FieldCreateParams < LegalesignSDK::Internal::Type::BaseModel
        extend LegalesignSDK::Internal::Type::RequestParameters::Converter
        include LegalesignSDK::Internal::Type::RequestParameters

        # @!attribute body
        #
        #   @return [Array<LegalesignSDK::Models::Templatepdf::FieldCreateParams::Body>]
        required :body,
                 -> { LegalesignSDK::Internal::Type::ArrayOf[LegalesignSDK::Templatepdf::FieldCreateParams::Body] }
        ...
        class Body < LegalesignSDK::Internal::Type::BaseModel
          # @!attribute ax
          ...
          #
          #   @return [Symbol, LegalesignSDK::Models::Templatepdf::FieldCreateParams::Body::ElementType]
          required :element_type, enum: -> { LegalesignSDK::Templatepdf::FieldCreateParams::Body::ElementType }
          ...
          #   - 3 - right
          #
          #   @return [Integer, LegalesignSDK::Models::Templatepdf::FieldCreateParams::Body::Align, nil]
          optional :align, enum: -> { LegalesignSDK::Templatepdf::FieldCreateParams::Body::Align }, nil?: true
          ...
          # @!attribute font_name
          #
          #   @return [Symbol, LegalesignSDK::Models::Templatepdf::FieldCreateParams::Body::FontName, nil]
          optional :font_name, enum: -> { LegalesignSDK::Templatepdf::FieldCreateParams::Body::FontName }
          ...
          #
          #   @return [Integer, LegalesignSDK::Models::Templatepdf::FieldCreateParams::Body::LogicAction, nil]
          optional :logic_action, enum: -> { LegalesignSDK::Templatepdf::FieldCreateParams::Body::LogicAction }
          ...
          #   {LegalesignSDK::Models::Templatepdf::FieldCreateParams::Body} for more details.
          #
          ...
          #
          #   @param element_type [Symbol, LegalesignSDK::Models::Templatepdf::FieldCreateParams::Body::ElementType] Must be one of the following: _ signature - signature field _ initials - initial
          #
          #   @param page [Integer] which page to place field on
          #
          #   @param signer [Integer] 1-indexed number of signer (witness+100) (approver+200)
          #
          #   @param align [Integer, LegalesignSDK::Models::Templatepdf::FieldCreateParams::Body::Align, nil] one of the following:
          #
          #   @param fieldorder [Integer, nil] Ordering of fields as the signer progresses (top-down by if left blank)
          #
          #   @param font_name [Symbol, LegalesignSDK::Models::Templatepdf::FieldCreateParams::Body::FontName]
          #
          ...
          #
          #   @param logic_action [Integer, LegalesignSDK::Models::Templatepdf::FieldCreateParams::Body::LogicAction] offers options for more advanced forms
          #
          ...
          # sender field (field to complete by admin user when sending, use pdftext)
          #
          # @see LegalesignSDK::Models::Templatepdf::FieldCreateParams::Body#element_type
          module ElementType
          ...
          # - 3 - right
          #
          # @see LegalesignSDK::Models::Templatepdf::FieldCreateParams::Body#align
          module Align
            extend LegalesignSDK::Internal::Type::Enum
          ...
          # @see LegalesignSDK::Models::Templatepdf::FieldCreateParams::Body#font_name
          module FontName
            extend LegalesignSDK::Internal::Type::Enum
          ...
          # = Sum a set of fields 3 = Conditional upon another field
          #
          # @see LegalesignSDK::Models::Templatepdf::FieldCreateParams::Body#logic_action
          module LogicAction
            extend LegalesignSDK::Internal::Type::Enum
