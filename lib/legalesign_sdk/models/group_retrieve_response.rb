...
module LegalesignSDK
  module Models
    # @see LegalesignSDK::Resources::Group#retrieve
    class GroupRetrieveResponse < LegalesignSDK::Internal::Type::BaseModel
      # @!attribute created
      #
      #   @return [Time, nil]
      ...
      optional :members, LegalesignSDK::Internal::Type::ArrayOf[String]
