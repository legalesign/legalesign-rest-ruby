...
module LegalesignSDK
  module Models
    # @see LegalesignSDK::Resources::Document#retrieve
    class DocumentRetrieveResponse < LegalesignSDK::Internal::Type::BaseModel
      # @!attribute archived
      #
      #   @return [Boolean, nil]
      ...
      #
      #   @return [Boolean, nil]
      optional :sign_mouse, LegalesignSDK::Internal::Type::Boolean
      ...
      #
      #   @return [Boolean, nil]
      optional :sign_type, LegalesignSDK::Internal::Type::Boolean

      # @!attribute sign_upload
      #   legacy
      #
      #   @return [Boolean, nil]
      optional :sign_upload, LegalesignSDK::Internal::Type::Boolean
      ...
      #   {LegalesignSDK::Models::DocumentRetrieveResponse} for more details.
      #
