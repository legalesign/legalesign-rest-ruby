...
module LegalesignSDK
  module Models
    # @see LegalesignSDK::Resources::Templatepdf#retrieve
    class TemplatePdf < LegalesignSDK::Internal::Type::BaseModel
      # @!attribute created
      #
      #   @return [Time, nil]
      ...
      #
      #   @return [Boolean, nil]
      optional :valid, LegalesignSDK::Internal::Type::Boolean
