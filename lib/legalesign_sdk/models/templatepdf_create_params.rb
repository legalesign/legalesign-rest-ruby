...
module LegalesignSDK
  module Models
    # @see LegalesignSDK::Resources::Templatepdf#create
    class TemplatepdfCreateParams < LegalesignSDK::Internal::Type::BaseModel
      ...
      #
      #   @return [Boolean, nil]
      optional :archive_upon_send, LegalesignSDK::Internal::Type::Boolean

      # @!attribute process_tags
      #
      #   @return [Boolean, nil]
      optional :process_tags, LegalesignSDK::Internal::Type::Boolean
