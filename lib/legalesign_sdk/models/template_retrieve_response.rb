...
module LegalesignSDK
  module Models
    # @see LegalesignSDK::Resources::Template#retrieve
    class TemplateRetrieveResponse < LegalesignSDK::Internal::Type::BaseModel
      # @!attribute archive
      #
      #   @return [Boolean, nil]
      ...
      # @!method initialize(archive: nil, created: nil, group: nil, has_fields: nil, latest_text: nil, modified: nil, resource_uri: nil, signee_count: nil, title: nil, user: nil, uuid: nil)
      #   @param archive [Boolean]
      #   @param created [Time]
      #   @param group [String]
      #   @param has_fields [Boolean]
      #   @param latest_text [String]
      #   @param modified [Time]
