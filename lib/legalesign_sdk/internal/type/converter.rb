    ...
    module Type
      ...
      module Converter
        ...
        def dump(value, state:)
          case value
          in Array
            value.map { LegalesignSDK::Internal::Type::Unknown.dump(_1, state: state) }
          in Hash
            value.transform_values { LegalesignSDK::Internal::Type::Unknown.dump(_1, state: state) }
          ...
          in Pathname | IO
            ...
            LegalesignSDK::FilePart.new(value)
          in LegalesignSDK::FilePart
        ...
        class << self
          ...
          def type_info(spec)
            ...
            in LegalesignSDK::Internal::Type::Converter | Class | Symbol
              -> { spec }
          ...
          #
          # @param target [LegalesignSDK::Internal::Type::Converter, Class]
          #
          # @param value [Object]
          #
          ...
          #
          # @return [Object]
          def coerce(target, value, state: LegalesignSDK::Internal::Type::Converter.new_coerce_state)
            # rubocop:disable Metrics/BlockNesting
            exactness = state.fetch(:exactness)

            case target
            in LegalesignSDK::Internal::Type::Converter
          ...
          def dump(target, value, state: {can_retry: true})
            ...
            in LegalesignSDK::Internal::Type::Converter
              ...
              LegalesignSDK::Internal::Type::Unknown.dump(value, state: state)
            end
          end
        ...
        define_sorbet_constant!(:Input) do
          T.type_alias { T.any(LegalesignSDK::Internal::Type::Converter, T::Class[T.anything]) }
        end
