...
module LegalesignSDK
  module Resources
    class Document
      ...
      #
      # @return [LegalesignSDK::Models::DocumentCreateResponse]
      #
      # @see LegalesignSDK::Models::DocumentCreateParams
      def create(params)
        parsed, options = LegalesignSDK::DocumentCreateParams.dump_request(params)
        @client.request(
          method: :post,
          path: "document/",
          body: parsed,
          model: LegalesignSDK::Models::DocumentCreateResponse,
          options: options
        )
      end
      ...
      # @param request_options [LegalesignSDK::RequestOptions, Hash{Symbol=>Object}, nil]
      #
      # @return [LegalesignSDK::Models::DocumentRetrieveResponse]
      #
      # @see LegalesignSDK::Models::DocumentRetrieveParams
      def retrieve(doc_id, params = {})
        @client.request(
          method: :get,
          path: ["document/%1$s/", doc_id],
          model: LegalesignSDK::Models::DocumentRetrieveResponse,
          options: params[:request_options]
        )
      end

      # Some parameter documentations has been truncated, see
      # {LegalesignSDK::Models::DocumentListParams} for more details.
      #
      ...
      # @param request_options [LegalesignSDK::RequestOptions, Hash{Symbol=>Object}, nil]
      #
      # @return [LegalesignSDK::Models::DocumentListResponse]
      #
      # @see LegalesignSDK::Models::DocumentListParams
      def list(params)
        parsed, options = LegalesignSDK::DocumentListParams.dump_request(params)
        @client.request(
          method: :get,
          path: "document/",
          query: parsed,
          model: LegalesignSDK::Models::DocumentListResponse,
          options: options
        )
      end
      ...
      # @return [nil]
      #
      # @see LegalesignSDK::Models::DocumentArchiveParams
      ...
      # @param request_options [LegalesignSDK::RequestOptions, Hash{Symbol=>Object}, nil]
      #
      # @return [Array<LegalesignSDK::Models::DocumentGetFieldsResponseItem>]
      #
      # @see LegalesignSDK::Models::DocumentGetFieldsParams
      def get_fields(doc_id, params = {})
        @client.request(
          method: :get,
          path: ["document/%1$s/fields/", doc_id],
          model: LegalesignSDK::Internal::Type::ArrayOf[LegalesignSDK::Models::DocumentGetFieldsResponseItem],
          options: params[:request_options]
        )
      end
      ...
      #
      # @overload permanently_delete(doc_id, request_options: {})
      #
      # @param doc_id [String] document id
      #
      # @param request_options [LegalesignSDK::RequestOptions, Hash{Symbol=>Object}, nil]
      ...
      # @return [nil]
      #
      # @see LegalesignSDK::Models::DocumentPermanentlyDeleteParams
      def permanently_delete(doc_id, params = {})
        @client.request(
          method: :delete,
