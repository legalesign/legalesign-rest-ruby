...
module LegalesignSDK
  module Resources
    class Templatepdf
      # @return [LegalesignSDK::Resources::Templatepdf::Fields]
      attr_reader :fields
      ...
      # @return [nil]
      #
      # @see LegalesignSDK::Models::TemplatepdfCreateParams
      def create(params)
        parsed, options = LegalesignSDK::TemplatepdfCreateParams.dump_request(params)
      ...
      # @param request_options [LegalesignSDK::RequestOptions, Hash{Symbol=>Object}, nil]
      #
      # @return [LegalesignSDK::Models::TemplatePdf]
      #
      # @see LegalesignSDK::Models::TemplatepdfRetrieveParams
      def retrieve(pdf_id, params = {})
        @client.request(
          method: :get,
          path: ["templatepdf/%1$s/", pdf_id],
          model: LegalesignSDK::TemplatePdf,
          options: params[:request_options]
        )
      end

      # Some parameter documentations has been truncated, see
      # {LegalesignSDK::Models::TemplatepdfListParams} for more details.
      #
      # Get PDF templates
      #
      ...
      # @param request_options [LegalesignSDK::RequestOptions, Hash{Symbol=>Object}, nil]
      #
      # @return [LegalesignSDK::Models::TemplatepdfListResponse]
      #
      # @see LegalesignSDK::Models::TemplatepdfListParams
      def list(params = {})
        parsed, options = LegalesignSDK::TemplatepdfListParams.dump_request(params)
        @client.request(
          method: :get,
          path: "templatepdf/",
          query: parsed,
          model: LegalesignSDK::Models::TemplatepdfListResponse,
          options: options
        )
      end
      ...
      # @return [String]
      #
      # @see LegalesignSDK::Models::TemplatepdfGetEditLinkParams
      ...
      def initialize(client:)
        @client = client
        @fields = LegalesignSDK::Resources::Templatepdf::Fields.new(client: client)
      end
    end
  end
end
