...
module LegalesignSDK
  module Resources
    class Template
      ...
      # @return [nil]
      #
      # @see LegalesignSDK::Models::TemplateCreateParams
      def create(params)
        parsed, options = LegalesignSDK::TemplateCreateParams.dump_request(params)
      ...
      # @param request_options [LegalesignSDK::RequestOptions, Hash{Symbol=>Object}, nil]
      #
      # @return [LegalesignSDK::Models::TemplateRetrieveResponse]
      #
      # @see LegalesignSDK::Models::TemplateRetrieveParams
      def retrieve(template_id, params = {})
        @client.request(
          method: :get,
          path: ["template/%1$s/", template_id],
          model: LegalesignSDK::Models::TemplateRetrieveResponse,
      ...
      # @return [nil]
      #
      # @see LegalesignSDK::Models::TemplateUpdateParams
      def update(template_id, params)
        parsed, options = LegalesignSDK::TemplateUpdateParams.dump_request(params)
        @client.request(
          method: :patch,
          path: ["template/%1$s/", template_id],
          body: parsed[:body],
      ...
      # @param request_options [LegalesignSDK::RequestOptions, Hash{Symbol=>Object}, nil]
      #
      # @return [LegalesignSDK::Models::TemplateListResponse]
      #
      # @see LegalesignSDK::Models::TemplateListParams
      def list(params = {})
        parsed, options = LegalesignSDK::TemplateListParams.dump_request(params)
        @client.request(
          method: :get,
          path: "template/",
          query: parsed,
          model: LegalesignSDK::Models::TemplateListResponse,
          options: options
        )
      end
