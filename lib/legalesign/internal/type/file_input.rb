...
module Legalesign
  module Internal
    module Type
      ...
      # `Legalesign::Internal::Type::FileInput`.
      #
      ...
      class FileInput
        ...
        def self.===(other)
          case other
          in Pathname | StringIO | IO | String | Legalesign::FilePart
            true
          else
            false
          end
        ...
        #
        # @return [Boolean]
        def self.==(other) = other.is_a?(Class) && other <= Legalesign::Internal::Type::FileInput
        ...
        class << self
          ...
          def dump(value, state:)
            ...
            in Legalesign::FilePart if value.content.is_a?(IO)
              state[:can_retry] = false
            else
            end
