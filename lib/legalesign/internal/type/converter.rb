    ...
    module Type
      ...
      module Converter
        ...
        def dump(value, state:)
          case value
          in Array
            value.map { Legalesign::Internal::Type::Unknown.dump(_1, state: state) }
          in Hash
            value.transform_values { Legalesign::Internal::Type::Unknown.dump(_1, state: state) }
          ...
          in Pathname | IO
            ...
            Legalesign::FilePart.new(value)
          in Legalesign::FilePart
        ...
        class << self
          ...
          def type_info(spec)
            ...
            in Legalesign::Internal::Type::Converter | Class | Symbol
              -> { spec }
          ...
          #
          # @param target [Legalesign::Internal::Type::Converter, Class]
          #
          # @param value [Object]
          #
          ...
          #
          # @return [Object]
          def coerce(target, value, state: Legalesign::Internal::Type::Converter.new_coerce_state)
            # rubocop:disable Metrics/BlockNesting
            exactness = state.fetch(:exactness)

            case target
            in Legalesign::Internal::Type::Converter
          ...
          def dump(target, value, state: {can_retry: true})
            ...
            in Legalesign::Internal::Type::Converter
              ...
              Legalesign::Internal::Type::Unknown.dump(value, state: state)
            end
          end
        ...
        define_sorbet_constant!(:Input) do
          T.type_alias { T.any(Legalesign::Internal::Type::Converter, T::Class[T.anything]) }
        end
