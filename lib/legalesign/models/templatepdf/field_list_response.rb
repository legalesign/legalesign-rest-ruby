  ...
  module Models
    module Templatepdf
      ...
      class FieldListResponse < Legalesign::Internal::Type::BaseModel
        ...
        # @!attribute objects
        #
        #   @return [Array<Legalesign::Models::Templatepdf::FieldListResponse::Object>, nil]
        optional :objects,
                 -> { Legalesign::Internal::Type::ArrayOf[Legalesign::Models::Templatepdf::FieldListResponse::Object] }

        # @!method initialize(meta: nil, objects: nil)
        #   @param meta [Legalesign::Models::ListMeta]
        #   @param objects [Array<Legalesign::Models::Templatepdf::FieldListResponse::Object>]
        ...
        class Object < Legalesign::Internal::Type::BaseModel
          ...
          #
          #   @return [Symbol, Legalesign::Models::Templatepdf::FieldListResponse::Object::ElementType]
          required :element_type,
                   enum: -> { Legalesign::Models::Templatepdf::FieldListResponse::Object::ElementType }
          ...
          #   - 3 - right
          #
          #   @return [Integer, Legalesign::Models::Templatepdf::FieldListResponse::Object::Align, nil]
          optional :align,
                   enum: -> { Legalesign::Models::Templatepdf::FieldListResponse::Object::Align },
                   nil?: true
          ...
          # @!attribute font_name
          #
          #   @return [Symbol, Legalesign::Models::Templatepdf::FieldListResponse::Object::FontName, nil]
          optional :font_name, enum: -> { Legalesign::Models::Templatepdf::FieldListResponse::Object::FontName }
          ...
          #
          #   @return [Integer, Legalesign::Models::Templatepdf::FieldListResponse::Object::LogicAction, nil]
          optional :logic_action,
                   enum: -> { Legalesign::Models::Templatepdf::FieldListResponse::Object::LogicAction }
          ...
          #   {Legalesign::Models::Templatepdf::FieldListResponse::Object} for more details.
          #
          ...
          #
          #   @param element_type [Symbol, Legalesign::Models::Templatepdf::FieldListResponse::Object::ElementType] Must be one of the following: _ signature - signature field _ initials - initia
          #
          ...
          #
          #   @param align [Integer, Legalesign::Models::Templatepdf::FieldListResponse::Object::Align, nil] one of the following:
          #
          #   @param fieldorder [Integer] order signer progresses through fields, top-down if blank
          #
          #   @param font_name [Symbol, Legalesign::Models::Templatepdf::FieldListResponse::Object::FontName]
          #
          ...
          #
          #   @param logic_action [Integer, Legalesign::Models::Templatepdf::FieldListResponse::Object::LogicAction] offers options for more advanced forms 1 = One of a set of field (radio group),
          #
          ...
          # sender field (field to complete by admin user when sending)
          #
          # @see Legalesign::Models::Templatepdf::FieldListResponse::Object#element_type
          module ElementType
          ...
          # - 3 - right
          #
          # @see Legalesign::Models::Templatepdf::FieldListResponse::Object#align
          module Align
            extend Legalesign::Internal::Type::Enum
          ...
          # @see Legalesign::Models::Templatepdf::FieldListResponse::Object#font_name
          module FontName
            extend Legalesign::Internal::Type::Enum
          ...
          # 2 = Sum a set of fields, 3 = Conditional upon another field
          #
          # @see Legalesign::Models::Templatepdf::FieldListResponse::Object#logic_action
          module LogicAction
            extend Legalesign::Internal::Type::Enum
