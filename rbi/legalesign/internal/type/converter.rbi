  ...
  module Internal
    module Type
      ...
      module Converter
        ...
        Input =
          T.type_alias do
            T.any(Legalesign::Internal::Type::Converter, T::Class[T.anything])
          end
        ...
        class << self
          ...
          sig do
            params(translate_names: T::Boolean).returns(
              Legalesign::Internal::Type::Converter::CoerceState
            )
          end
          ...
          sig do
            params(
              target: Legalesign::Internal::Type::Converter::Input,
              value: T.anything,
              state: Legalesign::Internal::Type::Converter::CoerceState
            ).returns(T.anything)
          end
