  ...
  module Models
    class TemplateListResponse < Legalesign::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Legalesign::Models::TemplateListResponse,
      ...
      sig do
        returns(
          T.nilable(T::Array[Legalesign::Models::TemplateListResponse::Object])
        )
      end
      attr_reader :objects
      ...
      sig do
        params(
          objects:
            T::Array[Legalesign::Models::TemplateListResponse::Object::OrHash]
        ).void
      end
      attr_writer :objects
        ...
        override.returns(
          {
            ...
            objects: T::Array[Legalesign::Models::TemplateListResponse::Object]
          }
        )
      end
      def to_hash
      ...
      class Object < Legalesign::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              Legalesign::Models::TemplateListResponse::Object,
              Legalesign::Internal::AnyHash
            )
          end
