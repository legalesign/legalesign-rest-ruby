  ...
  module Models
    class StatusRetrieveAllResponse < Legalesign::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            Legalesign::Models::StatusRetrieveAllResponse,
      ...
      sig { returns(T.nilable(T::Array[Legalesign::StatusResponse])) }
      attr_reader :objects

      sig { params(objects: T::Array[Legalesign::StatusResponse::OrHash]).void }
      attr_writer :objects

      sig do
        params(
          meta: Legalesign::ListMeta::OrHash,
          objects: T::Array[Legalesign::StatusResponse::OrHash]
        ...
        override.returns(
          {
            ...
            objects: T::Array[Legalesign::StatusResponse]
          }
        )
      end
      def to_hash
