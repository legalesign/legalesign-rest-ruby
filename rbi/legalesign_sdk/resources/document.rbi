  ...
  module Resources
    class Document
      ...
      sig do
        ...
        ).returns(LegalesignSDK::Models::DocumentCreateResponse)
      end
      def create(
        group:,
        name:,
      ...
      sig do
        params(
          doc_id: String,
          request_options: LegalesignSDK::RequestOptions::OrHash
        ).returns(LegalesignSDK::Models::DocumentRetrieveResponse)
      end
      def retrieve(
        # document id
        doc_id,
      ...
      sig do
        params(
          ...
          status: Integer,
          request_options: LegalesignSDK::RequestOptions::OrHash
        ).returns(LegalesignSDK::Models::DocumentListResponse)
      end
      def list(
      ...
      sig do
        params(
          ...
          T::Array[LegalesignSDK::Models::DocumentGetFieldsResponseItem]
        )
      end
      def get_fields(
        # document id
