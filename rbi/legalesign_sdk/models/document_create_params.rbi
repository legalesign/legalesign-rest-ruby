  ...
  module Models
    class DocumentCreateParams < LegalesignSDK::Internal::Type::BaseModel
      ...
      OrHash =
        T.type_alias do
          T.any(
            LegalesignSDK::DocumentCreateParams,
      ...
      sig { returns(T::Array[LegalesignSDK::DocumentCreateParams::Signer]) }
      ...
      sig do
        returns(
          T.nilable(
            LegalesignSDK::DocumentCreateParams::PdfPasswordType::OrInteger
          )
        )
      end
      ...
      sig do
        params(
          ...
          name: String,
          signers:
            T::Array[LegalesignSDK::DocumentCreateParams::Signer::OrHash],
        ...
        override.returns(
          {
            group: String,
            name: String,
            signers: T::Array[LegalesignSDK::DocumentCreateParams::Signer],
            append_pdf: T::Boolean,
            auto_archive: T::Boolean,
            cc_emails: String,
            convert_sender_to_signer: T::Boolean,
      ...
      class Signer < LegalesignSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              LegalesignSDK::DocumentCreateParams::Signer,
              LegalesignSDK::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(
              T::Array[LegalesignSDK::DocumentCreateParams::Signer::Reviewer]
            )
          )
        end
        ...
        sig do
          params(
            reviewers:
              T::Array[
                LegalesignSDK::DocumentCreateParams::Signer::Reviewer::OrHash
              ]
          ).void
        end
        ...
        sig do
          returns(
            T.nilable(
              LegalesignSDK::DocumentCreateParams::Signer::Role::OrSymbol
            )
          )
        end
        attr_reader :role
        ...
        sig do
          params(
            role: LegalesignSDK::DocumentCreateParams::Signer::Role::OrSymbol
          ).void
        end
        attr_writer :role
        ...
        class Reviewer < LegalesignSDK::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                LegalesignSDK::DocumentCreateParams::Signer::Reviewer,
                LegalesignSDK::Internal::AnyHash
              )
            end
        ...
        module Role
          ...
          TaggedSymbol =
            T.type_alias do
              T.all(Symbol, LegalesignSDK::DocumentCreateParams::Signer::Role)
            end
          ...
          WITNESS =
            T.let(
              :witness,
              LegalesignSDK::DocumentCreateParams::Signer::Role::TaggedSymbol
            )
          APPROVER =
            T.let(
              :approver,
      ...
      module PdfPasswordType
        ...
        TaggedInteger =
          T.type_alias do
            T.all(Integer, LegalesignSDK::DocumentCreateParams::PdfPasswordType)
          end
        ...
        PDF_PASSWORD_TYPE_1 =
          T.let(
            1,
            LegalesignSDK::DocumentCreateParams::PdfPasswordType::TaggedInteger
          )
        PDF_PASSWORD_TYPE_2 =
          T.let(
            2,
