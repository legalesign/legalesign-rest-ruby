  ...
  module Models
    class TemplateListResponse < LegalesignSDK::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            LegalesignSDK::Models::TemplateListResponse,
      ...
      sig do
        returns(
          T.nilable(
            T::Array[LegalesignSDK::Models::TemplateListResponse::Object]
          )
        )
      end
      attr_reader :objects
      ...
      sig do
        params(
          objects:
            T::Array[
              LegalesignSDK::Models::TemplateListResponse::Object::OrHash
            ]
        ).void
      end
      attr_writer :objects
      ...
      class Object < LegalesignSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              LegalesignSDK::Models::TemplateListResponse::Object,
              LegalesignSDK::Internal::AnyHash
            )
          end
