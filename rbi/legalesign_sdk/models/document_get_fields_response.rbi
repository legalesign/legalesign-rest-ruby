  ...
  module Models
    class DocumentGetFieldsResponseItem < LegalesignSDK::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            LegalesignSDK::Models::DocumentGetFieldsResponseItem,
      ...
      sig do
        returns(
          T.nilable(
            LegalesignSDK::Models::DocumentGetFieldsResponseItem::ElementType::TaggedSymbol
          )
        )
      end
      ...
      sig do
        params(
          element_type:
            LegalesignSDK::Models::DocumentGetFieldsResponseItem::ElementType::OrSymbol
        ).void
      end
      ...
      # - 92 - honorifics list
      sig do
        returns(T.nilable(LegalesignSDK::PdfFieldValidationEnum::TaggedInteger))
      end
      ...
      module ElementType
        ...
        TaggedSymbol =
          T.type_alias do
            T.all(
              Symbol,
              LegalesignSDK::Models::DocumentGetFieldsResponseItem::ElementType
            )
          end
