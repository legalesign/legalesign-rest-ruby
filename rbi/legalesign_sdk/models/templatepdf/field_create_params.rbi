    ...
    module Templatepdf
      class FieldCreateParams < LegalesignSDK::Internal::Type::BaseModel
        ...
        OrHash =
          T.type_alias do
            T.any(
              LegalesignSDK::Templatepdf::FieldCreateParams,
              LegalesignSDK::Internal::AnyHash
            )
          end

        sig do
          returns(T::Array[LegalesignSDK::Templatepdf::FieldCreateParams::Body])
        end
        attr_accessor :body
        ...
        sig do
          override.returns(
            {
              body:
                T::Array[LegalesignSDK::Templatepdf::FieldCreateParams::Body],
        ...
        class Body < LegalesignSDK::Internal::Type::BaseModel
          OrHash =
            T.type_alias do
              T.any(
                LegalesignSDK::Templatepdf::FieldCreateParams::Body,
                LegalesignSDK::Internal::AnyHash
              )
            end
          ...
          sig do
            returns(
              LegalesignSDK::Templatepdf::FieldCreateParams::Body::ElementType::OrSymbol
            )
          end
          ...
          sig do
            returns(
              T.nilable(
                LegalesignSDK::Templatepdf::FieldCreateParams::Body::Align::OrInteger
              )
            )
          end
          attr_accessor :align
          ...
          sig do
            returns(
              T.nilable(
                LegalesignSDK::Templatepdf::FieldCreateParams::Body::FontName::OrSymbol
              )
            )
          end
          ...
          sig do
            returns(
              T.nilable(
                LegalesignSDK::Templatepdf::FieldCreateParams::Body::LogicAction::OrInteger
              )
            )
          end
          ...
          # - 92 - honorifics list
          sig do
            returns(T.nilable(LegalesignSDK::PdfFieldValidationEnum::OrInteger))
          end
          ...
          module ElementType
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  LegalesignSDK::Templatepdf::FieldCreateParams::Body::ElementType
                )
              end
            ...
            SIGNATURE =
              T.let(
                :signature,
                LegalesignSDK::Templatepdf::FieldCreateParams::Body::ElementType::TaggedSymbol
              )
            INITIALS =
              T.let(
                :initials,
          ...
          module Align
            ...
            TaggedInteger =
              T.type_alias do
                T.all(
                  Integer,
                  LegalesignSDK::Templatepdf::FieldCreateParams::Body::Align
                )
              end
            ...
            ALIGN_1 =
              T.let(
                1,
                LegalesignSDK::Templatepdf::FieldCreateParams::Body::Align::TaggedInteger
              )
            ALIGN_2 =
              T.let(
                2,
          ...
          module FontName
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  LegalesignSDK::Templatepdf::FieldCreateParams::Body::FontName
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
            ...
            EMPTY =
              T.let(
                :"",
                LegalesignSDK::Templatepdf::FieldCreateParams::Body::FontName::TaggedSymbol
              )
            ARIAL =
              T.let(
                :arial,
          ...
          module LogicAction
            ...
            TaggedInteger =
              T.type_alias do
                T.all(
                  Integer,
                  LegalesignSDK::Templatepdf::FieldCreateParams::Body::LogicAction
                )
              end
            OrInteger = T.type_alias { Integer }
            ...
            LOGIC_ACTION_1 =
              T.let(
                1,
                LegalesignSDK::Templatepdf::FieldCreateParams::Body::LogicAction::TaggedInteger
              )
            LOGIC_ACTION_2 =
              T.let(
                2,
