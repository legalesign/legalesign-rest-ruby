    ...
    module Templatepdf
      class FieldListResponse < LegalesignSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              LegalesignSDK::Models::Templatepdf::FieldListResponse,
        ...
        sig do
          returns(
            T.nilable(
              T::Array[
                LegalesignSDK::Models::Templatepdf::FieldListResponse::Object
              ]
            )
          )
        end
        ...
        sig do
          params(
            objects:
              T::Array[
                LegalesignSDK::Models::Templatepdf::FieldListResponse::Object::OrHash
              ]
          ).void
        end
        attr_writer :objects
        ...
        class Object < LegalesignSDK::Internal::Type::BaseModel
          ...
          sig do
            returns(
              LegalesignSDK::Models::Templatepdf::FieldListResponse::Object::ElementType::TaggedSymbol
            )
          end
          ...
          sig do
            returns(
              T.nilable(
                LegalesignSDK::Models::Templatepdf::FieldListResponse::Object::Align::TaggedInteger
              )
            )
          end
          attr_accessor :align
          ...
          sig do
            returns(
              T.nilable(
                LegalesignSDK::Models::Templatepdf::FieldListResponse::Object::FontName::TaggedSymbol
              )
            )
          end
          ...
          sig do
            params(
              font_name:
                LegalesignSDK::Models::Templatepdf::FieldListResponse::Object::FontName::OrSymbol
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(
                LegalesignSDK::Models::Templatepdf::FieldListResponse::Object::LogicAction::TaggedInteger
              )
            )
          end
          ...
          sig do
            params(
              logic_action:
                LegalesignSDK::Models::Templatepdf::FieldListResponse::Object::LogicAction::OrInteger
            ).void
          end
          ...
          sig do
            returns(
              T.nilable(LegalesignSDK::PdfFieldValidationEnum::TaggedInteger)
            )
          end
          ...
          sig do
            params(
              ...
              by: Float,
              element_type:
                LegalesignSDK::Models::Templatepdf::FieldListResponse::Object::ElementType::OrSymbol,
              page: Integer,
              signer: T.nilable(Integer),
              align:
                T.nilable(
                  LegalesignSDK::Models::Templatepdf::FieldListResponse::Object::Align::OrInteger
                ),
              fieldorder: Integer,
              font_name:
                LegalesignSDK::Models::Templatepdf::FieldListResponse::Object::FontName::OrSymbol,
              ...
              validation:
                T.nilable(LegalesignSDK::PdfFieldValidationEnum::OrInteger),
              value: String
            ).returns(T.attached_class)
          end
          def self.new(
            ...
            override.returns(
              {
                ...
                validation:
                  T.nilable(
                    LegalesignSDK::PdfFieldValidationEnum::TaggedInteger
                  ),
                value: String
              }
            )
          ...
          module ElementType
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  LegalesignSDK::Models::Templatepdf::FieldListResponse::Object::ElementType
                )
              end
          ...
          module Align
            ...
            TaggedInteger =
              T.type_alias do
                T.all(
                  Integer,
                  LegalesignSDK::Models::Templatepdf::FieldListResponse::Object::Align
                )
              end
          ...
          module FontName
            ...
            TaggedSymbol =
              T.type_alias do
                T.all(
                  Symbol,
                  LegalesignSDK::Models::Templatepdf::FieldListResponse::Object::FontName
                )
              end
            OrSymbol = T.type_alias { T.any(Symbol, String) }
          ...
          module LogicAction
            ...
            TaggedInteger =
              T.type_alias do
                T.all(
                  Integer,
                  LegalesignSDK::Models::Templatepdf::FieldListResponse::Object::LogicAction
                )
              end
            OrInteger = T.type_alias { Integer }
