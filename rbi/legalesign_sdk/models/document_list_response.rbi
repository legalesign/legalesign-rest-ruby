  ...
  module Models
    class DocumentListResponse < LegalesignSDK::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            LegalesignSDK::Models::DocumentListResponse,
      ...
      sig do
        returns(
          T.nilable(
            T::Array[LegalesignSDK::Models::DocumentListResponse::Object]
          )
        )
      end
      attr_reader :objects
      ...
      sig do
        params(
          objects:
            T::Array[
              LegalesignSDK::Models::DocumentListResponse::Object::OrHash
            ]
        ).void
      end
      attr_writer :objects
      ...
      class Object < LegalesignSDK::Internal::Type::BaseModel
        OrHash =
          T.type_alias do
            T.any(
              LegalesignSDK::Models::DocumentListResponse::Object,
              LegalesignSDK::Internal::AnyHash
            )
          end
        ...
        sig do
          returns(
            T.nilable(
              LegalesignSDK::Models::DocumentListResponse::Object::SignersInOrder::TaggedInteger
            )
          )
        end
        ...
        sig do
          params(
            signers_in_order:
              LegalesignSDK::Models::DocumentListResponse::Object::SignersInOrder::OrInteger
          ).void
        end
        ...
        # - 50 - Rejected
        sig do
          returns(T.nilable(LegalesignSDK::DocumentStatusEnum::TaggedInteger))
        end
        attr_reader :status

        sig do
          params(status: LegalesignSDK::DocumentStatusEnum::OrInteger).void
        end
        attr_writer :status
        ...
        sig do
          params(
            ...
            signers_in_order:
              LegalesignSDK::Models::DocumentListResponse::Object::SignersInOrder::OrInteger,
            status: LegalesignSDK::DocumentStatusEnum::OrInteger,
            tag: String,
            tag1: String,
            tag2: String,
          ...
          override.returns(
            {
              ...
              signers_in_order:
                LegalesignSDK::Models::DocumentListResponse::Object::SignersInOrder::TaggedInteger,
              status: LegalesignSDK::DocumentStatusEnum::TaggedInteger,
              tag: String,
              tag1: String,
              tag2: String,
              template: T.nilable(String),
        ...
        module SignersInOrder
          ...
          TaggedInteger =
            T.type_alias do
              T.all(
                Integer,
                LegalesignSDK::Models::DocumentListResponse::Object::SignersInOrder
              )
            end
