...
module LegalesignSDK
  module Models
    class SignerRetrieveResponse < LegalesignSDK::Internal::Type::BaseModel
      OrHash =
        T.type_alias do
          T.any(
            LegalesignSDK::Models::SignerRetrieveResponse,
      ...
      # - 50 - downloaded
      # - 60 - rejected
      sig { returns(T.nilable(LegalesignSDK::SignerStatusEnum::TaggedInteger)) }
      attr_reader :status

      sig { params(status: LegalesignSDK::SignerStatusEnum::OrInteger).void }
      attr_writer :status
      ...
      sig do
        params(
          ...
          order: Integer,
          resource_uri: String,
          status: LegalesignSDK::SignerStatusEnum::OrInteger
        ...
        override.returns(
          {
            ...
            order: Integer,
            resource_uri: String,
            status: LegalesignSDK::SignerStatusEnum::TaggedInteger
          }
        )
      end
      def to_hash
